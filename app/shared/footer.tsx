    ...
    <footer className="mt-auto bg-gray-800 w-full max-w-7x1 py-10 px-4 sm:px-6 lg:px-8 mx-auto">
      <div className="grid grid-cols-1 md:grid-cols-3 items-center gap-5 text-center">
        ...
        <div className="text-center space-x-2">
          ...
          <a className="size-10 inline-flex justify-center items-center gap-x-2 text-sm font-semibold rounded-full border border-transparent text-gray-500 hover:text-gray-200 hover:bg-gradient-to-tl hover:from-sky-500 hover:to-blue-500 disabled:opacity-50 disabled:pointer-events-none" href="https://github.com/StarsAligned" target="_blank" aria-label="Github source code" title="Github source code">
            <svg className="flex-shrink-0 size-6" xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
